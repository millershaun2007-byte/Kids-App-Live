...
function loadLiteracyActivity(activityType) {
    ...
    switch(activityType) {
        case 'letters':
            container.innerHTML = createLettersActivity();
            break;
        case 'phonics':
            container.innerHTML = createPhonicsActivity();
            break;
        case 'spelling':
            container.innerHTML = createSpellingActivity();
            break;
        case 'vocabulary':
            container.innerHTML = createVocabularyActivity();
            break;
        case 'sight-words':
            container.innerHTML = createSightWordsActivity();
            break;
        case 'sentences':
            container.innerHTML = createSentencesActivity();
            break;
        case 'rhyming':
            container.innerHTML = createRhymingActivity();
            break;
        case 'reading':
            container.innerHTML = createReadingActivity();
            break;
    }
...
function attachLiteracyEventListeners() {
    ...
    const buttons = document.querySelectorAll('.letter-btn, .word-btn');
    buttons.forEach(btn => {
        btn.addEventListener('click', () => {
            checkLiteracyAnswer(btn.getAttribute('data-answer'));
        });
    });
    ...
    if (sentenceBtn) {
        ...
        draggables.forEach(word => {
            word.addEventListener('click', () => {
                ...
                builder.appendChild(word.cloneNode(true));
            });
        });
